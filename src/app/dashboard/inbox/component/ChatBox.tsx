...
import MobileInbox from "./MobileChatBox";
...
const ChatBox = () => {
  ...
  const parentItemName = `${parentItem?.firstName} ${
    parentItem?.middleName || ""
  } ${parentItem?.lastName}`;
                        ...
                        <Menu>
                          ...
                          <MenuList fontSize="14">
                            <MenuItem
                              ...
                              display={
                                parentItem?.userId !== message?.sender
                                  ? "none"
                                  : "flex"
                              }
                            >
